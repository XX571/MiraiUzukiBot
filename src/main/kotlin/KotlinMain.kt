...
object WithoutConfiguration {
    ...
    fun main(args: Array<String>): Unit = runBlocking {
        val bot = BotFactory.newBot(2652397602L, "1qaz2wsx3edc").alsoLogin()

        bot.getFriend(571529359)?.sendMessage("Hello, XX!")
        bot.eventChannel.subscribeAlways<FriendMessageEvent> {
            if (sender.id == 571529359L) {
                subject.sendMessage(message.quote() + "HeHe, you just said '${message.content}'")
            }
        }
    }
}
